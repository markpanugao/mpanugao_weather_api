        ...
        <div class="container mt-5">
            <div class="d-flex flex-row justify-content-center align-items-center">
                <div class="weather__card">
                    <div class="d-flex flex-row justify-content-center align-items-center">
                        <div class="p-3">
                            <h2 name="temperature">{{$data['temperature']}}&deg;</h2>
                        </div>
                        <div class="p-3">
                            <img name="icon_weather" src="{{$data['icon_weather']}}">
                        </div>
                        <div class="p-3">
                            <h5 name="date_today">{{$data['date_today']}}</h5>
                            <h5 name="time_today">{{$data['time_today']}}</h5>
                            <h3 name="city">{{$data['city']}}</h3>
                            <span name="main_weather" class="weather__description">{{$data['main_weather']}}</span>
                        </div>
                    </div>
                    <div class="weather__status d-flex flex-row justify-content-center align-items-center mt-3">
                        <div class="p-4 d-flex justify-content-center align-items-center">
                            ...
                            <span name="humidity">{{$data['humidity']}}%</span>
                        </div>
                        <div class="p-4 d-flex justify-content-center align-items-center">
                            <img src="https://svgur.com/i/oH_.svg">
                            <span name="temperature">{{$data['temperature']}}&deg;</span>
                        </div>
                        <div class="p-4 d-flex justify-content-center align-items-center">
                            <img src="https://svgur.com/i/oKS.svg">
                            <span name="wind_speed">{{$data['wind_speed']}} km/h</span>
                        </div>
                    </div>
                </div>
            </div>
